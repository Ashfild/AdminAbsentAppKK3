...
import 'create_profil_page_model.dart';
export 'create_profil_page_model.dart';

class CreateProfilPageWidget extends StatefulWidget {
  const CreateProfilPageWidget({
    Key? key,
    this.userRole,
    this.username,
    this.nohp,
...
class _CreateProfilPageWidgetState extends State<CreateProfilPageWidget> {
  late CreateProfilPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateProfilPageModel());
